			...
			<li class="nav-item dropdown">
				<a class="nav-link" data-toggle="dropdown" href="#">
					<div class="user-panel mb-0 d-flex">
						...
						<div class="info mt-1">
							<span class="float-right text-dark">{{ Helpers.ucwords(session.bo_user_name) }}</span>
						</div>
					</div>
				</a>
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="height: 200px;">
					...
					<div class="card card-widget widget-user">
						...
						<div class="widget-user-header bg-info" style="height: 200px;">
							<h5 class="widget-user-username">{{ session.bo_user_namalengkap }}</h3>
								<h6 class="widget-user-desc">{{ session.bo_user_jabatan }}</h6>
							</h5>
						</div>
